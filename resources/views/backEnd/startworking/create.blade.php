...
@section('title','Startworking Create')
@section('css')
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('startworkings.index')}}" class="btn btn-info  waves-effect waves-light btn-xs">Manage</a>
                </div>
                <h4 class="page-title">Startworking Create</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
