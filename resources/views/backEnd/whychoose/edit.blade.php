...
@section('title','Whychoose Update')
@section('css')
        ...
        <div class="card cust_card">
            ...
            <div class="card_top">
                ...
                <div class="card_head_widget text_right">
                    <a href="{{route('whychooses.index')}}" class="b_btn">Manage</a>
                </div>
            </div>
           </div>

            <div class="card-body form_card_body">
                <form action="{{route('whychooses.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
