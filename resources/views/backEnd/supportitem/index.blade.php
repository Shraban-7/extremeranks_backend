...
@section('title','Supportitem Manage')
        ...
        <div class="card cust_card">
            ...
            <div class="card_top">
                ...
                <div class="card_head_widget text_right">
                    <a href="{{route('supportitem.index')}}" class="b_btn">Manage</a>
                </div>
            </div>
           </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    @if($value->status == 1)
                                    <form method="post" action="{{route('supportitem.inactive')}}" class="d-inline"> 
                                    @csrf
                                    ...
                                    @else
                                    <form method="post" action="{{route('supportitem.active')}}" class="d-inline">
                                        @csrf
                                    <input type="hidden" value="{{$value->id}}" name="hidden_id">        
                                    ...
                                    <a href="{{route('supportitem.edit',$value->id)}}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>

                                    <form method="post" action="{{route('supportitem.destroy')}}" class="d-inline">        
                                        @csrf
                                    <input type="hidden" value="{{$value->id}}" name="hidden_id">
    ...
    <div class="col-12">
        <div class="card cust_card create_card">
            ...
            <div class="card-body form_card_body">
               <form action="{{route('supportitem.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    <div class="col-sm-12">
