        ...
        <div class="card cust_card">
            ...
            <div class="card_top">
                ...
                <div class="card_head_widget text_right">
                    <a href="{{route('success.index')}}" class="b_btn">Manage</a>
                </div>
            </div>
           </div>
                ...
                <form action="{{route('success.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('symbol') is-invalid @enderror" name="symbol" value="{{ $edit_data->symbol}}" id="symbol" required="">
                            @error('symbol')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
