        ...
        <main style="width:100%">
            <div style="margin: 20px 0px;padding:30px">
                <div style="padding: 20px">
                    ...
                    Thanks for ordering from extremeranks.com. We're currently processing your order. <br/>
                    <a href="https://extremeranks.com/backend/client/invoice/{{$invoiceid}}" target="_blank">Click to download invoice</a>
                </div>
            </div>
        </main>
