         ...
         <div class="card_head">
            <div class="card_top">
                <div class="card_head_widget">
                    <p>Edit General Setting</p>
                </div>
                <div class="card_head_widget text_right">
                    <a href="{{route('settings.index')}}" class="b_btn">Manage</a>
                </div>
            </div>
           </div>
                ...
                <form action="{{route('settings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"  value="{{$edit_data->email}}" id="email" >
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            <label for="phone" class="form-label">Invoice Phone</label>
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"  value="{{$edit_data->phone}}"  id="phone" >
                            @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{$edit_data->address}}" value="{{ old('address') }}"  id="address" >
                            @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$edit_data->website}}" class="form-control @error('website') is-invalid @enderror" name="website" value="{{ old('website') }}"  id="website" >
                            @error('website')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('footer_about') is-invalid @enderror" required name="footer_about"  id="footer_about">{{ $edit_data->footer_about }}</textarea>
                            @error('footer_about')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
