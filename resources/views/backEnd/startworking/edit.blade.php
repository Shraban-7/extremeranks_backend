...
@section('title','Startworking Update')
@section('css')
        ...
        <div class="card cust_card">
            ...
            <div class="card_top">
                <div class="card_head_widget">
                    <p>Edit Startworking</p>
                </div>
                <div class="card_head_widget text_right">
                    <a href="{{route('startworkings.index')}}" class="b_btn">Manage</a>
                </div>
            </div>
           </div>

            <div class="card-body form_card_body">
                <form action="{{route('startworkings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <img src="{{asset($edit_data->iconimage)}}" class="edit-image" alt="">
                            @error('iconimage')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
