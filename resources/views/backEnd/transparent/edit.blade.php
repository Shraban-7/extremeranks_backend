...
@section('title','Transparent Update')
@section('css')
    ...
    <div class="col-lg-12">
        <div class="card cust_card">
            ...
            <div class="card-body form_card_body">
                <form action="{{route('transparent.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
