        ...
        <main style="width:100%">
            <div style="margin: 20px 0px;padding:30px">
                <div style="padding: 20px">
                    <h4 style="font-size: 25px; text-align: center; color: blue;margin:0">Forgot Password Verify</h4>
                    <p style="font-size: 18px; color: blue;margin:15px 0">Please copy the below verify token and set up your new
                        password.</p>
                    <h5 style="font-size: 20px; font-weight: 400;margin:0">Forgot Verify Token: {{$passResetToken}}</h5>
