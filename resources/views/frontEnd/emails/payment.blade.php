        ...
        <main style="width:100%">
            <div style="margin: 20px 0px;padding:30px">
                <div style="padding: 20px">
                    <b>Dear {{$name}}, Your payment({{$order_id}}) has been due, Please clear your payment as soon as possible.</b><br/>
                    <a href="{{url('client/invoice/'.$rand_id)}}" target="_blank">Click to pay</a>
                </div>
            </div>
        </main>
