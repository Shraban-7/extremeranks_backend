...
@section('title','Blog Category Manage') 
@section('css')
                            ...
                            <tr style="vertical-align: middle;">
                                ...
                                <td>
                                    <div class="button-list">
                                        @if($value->status == 1)
                                        <form method="post" action="{{route('blogcategories.inactive')}}" class="d-inline">
                                            @csrf
                                        ...
                                        @else
                                        <form method="post" action="{{route('blogcategories.active')}}" class="d-inline">
                                            @csrf
                                            <input type="hidden" value="{{$value->id}}" name="hidden_id" />
                                        ...
                                        <a href="{{route('blogcategories.edit',$value->id)}}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
        ...
        <div class="col-12">
            <div class="card cust_card create_card" id="create">
                ...
                <div class="card-body form_card_body">
                    <form action="{{route('blogcategories.store')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
                        @csrf
                        <div class="col-sm-12">
                        ...
                        <!-- col end -->
                        <div>
                            <input type="submit" class="cust_sub_btn b_btn" value="Create Category" />
                        </div>
                    </form>
                </div>
                <!-- end card body-->
