        ...
        <main style="width:100%">
            <div style="margin: 20px 0px;padding:30px">
                <div style="padding: 20px">
                    <b>Dear {{$name}}, Your order({{$order_id}}) has been {{$order_status}}</b><br/>
                    You can check more details from login your customer panel<br/>
                    <a href="https://extremeranks.com/login" target="_blank">Login to Click</a>
                </div>
            </div>
        </main>
