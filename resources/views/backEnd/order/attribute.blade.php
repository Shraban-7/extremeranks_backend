        ...
        <div class="card cust_card">
            ...
            <div class="card-body">
               <div class="invoice_inner" style="padding:30px;;overflow: hidden">
                   <div class="billing_form" style="width:50%;float: left;">
                       <h4>Billing From</h4>
                   ...
                   <div class="billing_to"  style="width:50%;float: left;">
               ...
               <div class="service-info" style="padding:30px;overflow: hidden;">
                   ...
                   <table style="width: 100%;border:1px solid #ddd">
                       <thead>
                           <tr style="width:100%">
                               <td style="width:50%;float:left;padding:10px;background: #F3F5FA;">Attribute Name</td>
                               <td style="width:50%;float:left;padding:10px;background: #F3F5FA;">Attribute Value</td>
                           </tr>
                       </thead>
                       <tbody>
                        @foreach($orderattribute as $key=>$value)
                           <tr style="width:100%">
                               <td style="width:50%;float:left;padding:10px">{{$value->title}}</td>
                               <td style="width:50%;float:left;padding:10px">{{$value->value}}</td>
                           </tr>
                        @endforeach
                       </tbody>
                   </table>
