                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button-list">
                                                @if ($value->status == 1)
                                                    <form method="post" action="{{ route('team.inactive') }}"
                                                        class="d-inline">
                                                        @csrf
                                                ...
                                                @else
                                                    <form method="post" action="{{ route('team.active') }}"
                                                        class="d-inline">
                                                        @csrf
                                                        <input type="hidden" value="{{ $value->id }}" name="hidden_id">
                                                        <button type="button"
            ...
            <div class="col-12">
                <div class="card cust_card create_card" id="create">
                    ...
                    <div class="card-body form_card_body">
                        <form action="{{ route('team.store') }}" method="POST" class=row data-parsley-validate=""
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('department') is-invalid @enderror"
                                        name="department" value="{{ old('depertment') }}" id="depertment">
                                    @error('department')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
