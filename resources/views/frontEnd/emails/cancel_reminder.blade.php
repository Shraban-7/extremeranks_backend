        ...
        <main style="width:100%">
            <div style="margin: 20px 0px;padding:30px">
                <div style="padding: 20px">
                    <b>Dear {{$name}}, We hope this message finds you well. We regret to inform you that your recent order ({{$order_id}})  is scheduled for cancellation if immediate action is not taken.</b><br/>
                    <a href="{{url('client/invoice/'.$rand_id)}}" target="_blank">Click to view</a>
                </div>
            </div>
        </main>
